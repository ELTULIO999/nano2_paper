...
\bibliography{bibtex/bib/IEEEabrv.bib,bibtex/bib/references.bib}
...
\begin{IEEEkeywords}
  Efabless, SkyWater 130nm open-source PDK, Tiny Tapeout implementation, Multiproject wafer, Nano chip fabrication.
\end{IEEEkeywords}
...
\appendices\section{GitHub Repository}\label{sec:GitHub}
\input{appendix}
